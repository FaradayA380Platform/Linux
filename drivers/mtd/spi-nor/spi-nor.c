...
static const struct flash_info spi_nor_ids[] = {
	...
	{ "en25qh128",  INFO(0x1c7018, 0, 64 * 1024,  256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ "en25qh256",  INFO(0x1c7019, 0, 64 * 1024,  512, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	...
	/* Fudan */
	{ "fm25q64", INFO(0xa14017, 0, 64 * 1024, 128, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
...
/**
 * eon_quad_enable() - set QE bit in Status Register.
 * @nor:	pointer to a 'struct spi_nor'
 *
 * Set the Quad Enable (QE) bit in the Status Register.
 *
 * bit 6 of the Status Register is the QE bit for EON like QSPI memories.
 *
			       ...
			       struct spi_nor_flash_parameter *params)
{
	...
	if (info->flags & SPI_NOR_QUAD_READ) {
		if (JEDEC_MFR(info) == SNOR_MFR_EON) {
