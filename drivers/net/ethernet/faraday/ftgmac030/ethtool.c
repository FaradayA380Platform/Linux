			     ...
			     struct ethtool_eee *edata)
{
	 ...
	 * for ethtool.c
	 */
	tx_enter_cnt = (ctrl->tx_lpi_timer >> FTGMAC030_EEE_TX_ENTER_SHIFT) & FTGMAC030_EEE_TX_ENTER_MASK;
			     ...
			     struct ethtool_eee *edata)
{
	...
	ctrl->tx_lpi_timer = ((tx_enter_cnt << FTGMAC030_EEE_TX_ENTER_SHIFT) | tx_wake_cnt);
